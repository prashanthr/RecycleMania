    ...
    implements DropTarget, DragController.DragListener
{
    ...
    private static Boolean endstatus = false;
    private static int scorewas=0;
	 ...
	 */
	public int getscorewas()
	{
		return scorewas;
	}
	public void setscrewas (int inbound)
	{
		scorewas=inbound;
	}
	...
	public int determinebackground()
	{
		...
		for(index=0;index<bkList.size();index++)
		{
			comp = bkList.lastIndexOf(index);
			if(tempbkd==comp)
			{
				send= R.color.drop_target_color2;
			}
				
		}*/
		
		int tempbkd;
		tempbkd=getSavedBackground();
		if(tempbkd == R.drawable.paperbin)
		{
			tempbkd= R.drawable.paperbinin;
		}
		if(tempbkd == R.drawable.plasticbin)
		{
			tempbkd = R.drawable.plasticbinin;
		}
		if(tempbkd == R.drawable.metalbin)
		{
			tempbkd = R.drawable.metalbinin;
		}
	...
	public boolean isEnabledForItem(View mOriginator)
	{
		boolean ans= false;
		if(isPaperLayer())
		{
			int temp = mOriginator.getId();
			switch(temp)
			{
				case R.id.Image1:	
									ans= true;
	...
	public void pointstoastcorrect()
	{
		int temp=0;
		String tempnumber="";
		temp = pointscount;
		...
		String b1="[ ";
		String b2=" ]";
		String finalScore=bracket+good+plus+score+b1+tempnumber+b2+close;
		toast(finalScore);
		
	}
	public void pointstoastincorrect()
	{
		int temp=0;
		String tempnumber="";
		temp = pointscount;
		...
		String b1="[ ";
		String b2=" ]";
		String finalScore=bracket+bad+plus+score+b1+tempnumber+b2+close;
		toast(finalScore);
